...
const REQUIRED_ROUTE_PATTERNS = {
  ...
  'routes/donors.js': ["router.post('/import'", "router.get('/:id/history'", "router.get('/:id/eligibility'"],
...
console.log('  v0.5.0 API surface verified (campaigns, portal, import, docs)');